    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-gray-100 overflow-hidden pt-20">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="absolute top-40 right-20 animate-float animation-delay-2000">
          <FlameIcon className="w-10 h-10 text-orange-400 opacity-50" />
        </div>
        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-purple-600">
            ...
            {[
              {
                ...
                icon: (
                  <svg
                    ...
                    className="w-10 h-10 mb-4 text-black-400"
                    viewBox="0 0 50 50"
                  >
        ...
        <div className="text-center py-20 relative">
          ...
          {userId ? (
            <Button
              asChild
              className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-4 rounded-full text-lg transition duration-300 ease-in-out transform hover:scale-105"
            >
              <Link href="/generate">
            ...
            <SignUpButton mode="modal">
              <Button className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-4 rounded-full text-lg transition duration-300 ease-in-out transform hover:scale-105">
